...
import { PremiumWorkspaceLanding } from './components/PremiumWorkspaceLanding'
...
export default function App() {
  ...
  const pricingCount = activeRequests.filter(r => r.status === 'pricing').length
  const desktopLanding = <PremiumWorkspaceLanding requestCount={activeRequests.length} quoteCount={quotes.length} newCount={newCount} rfqCount={rfqCount} pricingCount={pricingCount} />
